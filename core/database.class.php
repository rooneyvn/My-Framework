...
final class My_Database {
    ...
    protected $_numericDataTypes = array(
        My_Database::INT_TYPE    => My_Database::INT_TYPE,
        My_Database::BIGINT_TYPE => My_Database::BIGINT_TYPE,
        My_Database::FLOAT_TYPE  => My_Database::FLOAT_TYPE
    );
    public function __construct() {
        ...
        $this->config->db_host  = $db['host'];
        $this->config->db_user  = $db['username'];
        $this->config->db_pass  = $db['password'];
